export default {
  compilerUrl: process.env.VUE_APP_COMPILER_URL || 'https://v6.compiler.aepps.com',
  ...
  ae_uat: {
    ...
    backendUrl: process.env.VUE_APP_AE_UAT_BACKEND_URL ||  'https://governance-server-testnet.prd.aepps.com',
  },
  ...
  ae_mainnet: {
    ...
    backendUrl: process.env.VUE_APP_AE_MAINNET_BACKEND_URL ||  'https://governance-server-mainnet.prd.aepps.com',
  }
};
