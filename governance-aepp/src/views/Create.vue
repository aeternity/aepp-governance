<template>
  <div>
    ...
    <div class="my-2 mx-4 flex items-center bg-white px-4" :class="{'bg-ae-error': !!errors.optionError}" v-for="option in options">
      ...
      <input v-model="option.text" @input="optionInput" type="text" placeholder="Add Option"
             class="ae-input-option w-full h-full px-2 py-6 outline-none" :class="{'bg-ae-error': !!errors.optionError}" />
    ...
    <div class="py-2 px-4 mb-16">
      <ae-input :error="!!errors.closeHeightError" type="number" v-model="closeHeightString" label="Close at height (optional)"></ae-input>
