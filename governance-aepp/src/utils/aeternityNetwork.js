...
aeternity.initProvider = async () => {
  try {
    ...
    aeternity.contract = await aeternity.client.getContractInstance(registryContractSource, {contractAddress: 'ct_2TcdyLxRPFKdLQ552zZAM6LjthsD79LWRAt1GtJJYpeS8jByjG'})
    return true
  } catch (e) {
    console.warn(e)
    return false
