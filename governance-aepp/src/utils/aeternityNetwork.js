...
aeternity.initProvider = async () => {
  try {
    ...
    aeternity.contract = await aeternity.client.getContractInstance(registryContractSource, {contractAddress: 'ct_2q3mNXvMABmVz7Jn1SCDxxG61y9iVo4JNzaveSMRHbE8TFxAsW'})
    return true
  } catch (e) {
    console.warn(e)
    return false
